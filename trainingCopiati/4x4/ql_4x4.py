...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='nets/4x4/routes.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/4x4/result_trainingCopiato_random(wait)corretto'
