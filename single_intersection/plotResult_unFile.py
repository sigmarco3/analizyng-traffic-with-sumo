...
if __name__ == '__main__':
    plotResult('D:/programmi/sumo/esperimenti semafori/Reinforcement-learning-in-traffic-light\outputs/2way-single-intersection/result-alpha0.99-gamma0.1 wait-static')
