...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='nets/2way-single-intersection/single-intersection-curriculum.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/2way-single-intersection/result-alpha0.99-gamma0.1 wait-cur'
    output_file = 'output-wait(leggero).csv'
