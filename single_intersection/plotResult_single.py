...
def plotResult(file,file2):  # script per conforntare simulazioni di 100000 secondi
       ...
       # plt.plot(x, ym)
        ...
        plt.errorbar(time,z1,yerr=std_error,marker="o",color="blue",markersize=2, label="qlearning indipendente")  #auto ferme su auto circolanti in funzione del tempo
        ...
        plt.title("rete 3x3 con reward 'wait' e semafori standard misura total stopped/running veicles ")
       ...
       #throughtput
        ...
        plt.errorbar(time, tput1, yerr=std_error, marker="o", color="blue", markersize=5, label="qlearning indipendente")
        tput2 = ar2/sc2
        ...
        plt.xlabel("time-step", size=12)
        plt.xticks(time, time)
        plt.title("rete 3x3 con reward 'wait' e semafori standard misura troughput")
        ...
        std_error = np.std(uc1, ddof=1) / np.sqrt(len(uc1))
        # create chart
        plt.errorbar(time,uc1,yerr=std_error,marker="o",color="blue",markersize=2, label="qlearning indipendente")
        ...
        plt.xlabel("time-step",size=12)
        plt.title("rete 3x3 con reward 'wait' e semafori standard misura mean waiting time ")
        ...
        # create chart
        plt.errorbar(time, vc1, yerr=std_error, marker="o",markersize=2, color="blue", label="qlearning indipendente")
        ...
        plt.title("rete 3x3 con reward 'wait' e semafori standard misura mean speed")
        plt.legend()
        plt.xticks(time, time)
        plt.grid()
...
if __name__ == '__main__':
        ...
        plotResult('D:/programmi/sumo/esperimenti semafori/Reinforcement-learning-in-traffic-light/outputs/4x4/result-training singoli_crescente(wait)1M',file2)