...
def plotResult(file,file2):
       ...
       # plt.plot(x, ym)
        ...
        plt.title("rete 4x4 reward 'wait' e varie reward misura total stopped/running veicles ", size=15)
       ...
       #throughtput
        ...
        plt.xlabel("time-step",size=15)
        plt.title("rete 4x4 reward wait e varie reward misura mean waiting time ",size=15)
        ...
        plt.xlabel("time-step ",size=15)
        plt.title("rete 4x4 reward wait e varie reward misura mean speed", size =15)
        plt.legend()
        plt.xticks(time, time)
        plt.grid()
