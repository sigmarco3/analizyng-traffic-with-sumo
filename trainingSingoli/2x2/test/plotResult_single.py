...
if __name__ == '__main__':
    plotResult('D:/programmi/sumo/esperimenti semafori/Reinforcement-learning-in-traffic-light/outputs/3x3/result-alpha0.1-gamma0.99_trainingCopiato_crescente(queue)')