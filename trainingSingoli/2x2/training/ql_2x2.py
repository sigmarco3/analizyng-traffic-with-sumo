...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='nets/2x2grid/2x2training.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/2x2/result-alpha0.1-gamma0.99 trainingSingoli_avg'
    ...
    for run in range(1, args.runs+1):
        ...
        for ts in ql_agents.keys():
            output_file = 'tabelleSingole 2x2-pressure-big' + ts +".csv"
