...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='nets/3x3grid/3x3routes.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/3x3/result-alpha0.1-gamma0.99_trainingSingoli_crescente(pressure)corretto'
