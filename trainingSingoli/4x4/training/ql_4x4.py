...
if __name__ == '__main__':
    ...
    prs = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                  description="""Q-Learning 4x4""")
    prs.add_argument("-route", dest="route", type=str, default='nets/4x4/4x4training.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/3x3/result-alpha0.1-gamma0.99 trainingSingoli_wait'

    env = SumoEnvironment(net_file='nets/4x4/4x4b.net.xml',
    ...
    for run in range(1, args.runs+1):
        ...
        for ts in ql_agents.keys():
            output_file = 'tabelleSingole 4x4-wait(corretto)' + ts +".csv"
